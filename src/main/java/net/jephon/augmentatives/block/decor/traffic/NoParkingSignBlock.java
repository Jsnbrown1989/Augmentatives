...
import net.jephon.augmentatives.util.SpeedLimitSpeeds;
...
public class NoParkingSignBlock
        extends Block {
    ...
    public NoParkingSignBlock(Settings settings) {
        super(settings);
    ...
    public BlockState onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        if (!world.isClient) {
            if (player.isCreative()) {
                NoParkingSignBlock.onBreakInCreative(world, pos, state, player);
            } else {
                BlockPos blockPos;
    ...
    private void placeAdditionalBlock(World world, BlockPos pos, BlockPos originPos, Direction direction, BlockState state, MultiBlockUtil.MultiblockPart part) {
        world.setBlockState(pos, ModBlocks.OUTSIDE_SIGN_NOPARKING.getDefaultState().with(PART, part).with(FACING, direction));
