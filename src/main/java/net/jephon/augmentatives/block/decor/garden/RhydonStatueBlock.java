...
public class RhydonStatueBlock
        extends Block {
    ...
    public RhydonStatueBlock(Settings settings) {
        super(settings);
    ...
    public BlockState onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        if (!world.isClient) {
            if (player.isCreative()) {
                RhydonStatueBlock.onBreakInCreative(world, pos, state, player);
            } else {
                BlockPos blockPos;
    ...
    private void placeAdditionalBlock(World world, BlockPos pos, BlockPos originPos, Direction direction, BlockState state, MultiBlockUtil.MultiblockPart part) {
        world.setBlockState(pos, ModBlocks.OUTSIDE_STATUE_RHYDON.getDefaultState().with(PART, part).with(FACING, direction));
