package net.jephon.augmentatives.block.decor.garden;
...
public class PokeballStatueBlock
        extends Block {
    ...
    public PokeballStatueBlock(Settings settings) {
        super(settings);
    ...
    public BlockState onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        if (!world.isClient) {
            if (player.isCreative()) {
                PokeballStatueBlock.onBreakInCreative(world, pos, state, player);
            } else {
                BlockPos blockPos;
    ...
    private void placeAdditionalBlock(World world, BlockPos pos, BlockPos originPos, Direction direction, BlockState state, MultiBlockUtil.MultiblockPart part) {
        world.setBlockState(pos, ModBlocks.OUTSIDE_STATUE_POKEBALL.getDefaultState().with(PART, part).with(FACING, direction));
