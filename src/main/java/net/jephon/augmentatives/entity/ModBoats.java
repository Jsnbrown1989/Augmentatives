...
public class ModBoats {
    public static final Identifier CHESTNUT_BOAT_ID = new Identifier(Augmentatives.MOD_ID, "chestnut_boat");
    public static final Identifier CHESTNUT_CHEST_BOAT_ID = new Identifier(Augmentatives.MOD_ID, "chestnut_chest_boat");
